...
SECRET_KEY = '6mm$3xs+6yxx%+@duwwmcsde_t#29j&amp;*vyvkligf-5sh@$+18@'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'anthill.server': {
            ...
            'filename': os.path.join(LOGGING_ROOT_DIR, 'game_controller.log'),
            'formatter': 'anthill.server',
...
GRAPHENE = {
    'SCHEMA': 'game_controller.api.v1.public.schema',
    'MIDDLEWARE': ()
}
