...
class GQLSubscriptionHandler(WebSocketHandler):
    @property
    def schema(self):
    ...
    def on_message(self, message):
        ...
        if op_type == GQL_CONNECTION_INIT:
            ...
            return self.send_error(op_id, Exception('Invalid message type: {}.'.format(op_type)))
    ...
    def on_start(self, op_id, params):
        try:
            execution_result = graphql(self.schema, **params, allow_subscriptions=True)
            assert isinstance(
