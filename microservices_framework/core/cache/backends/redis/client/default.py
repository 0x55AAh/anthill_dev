...
class DefaultClient:
    def __init__(self, server, params, backend):
        ...
        self.reverse_key = get_key_func(params.get("REVERSE_KEY_FUNCTION") or
                                        "microservices_framework.core.cache.backends.redis.util.default_reverse_key")
        ...
        serializer_path = self._options.get(
            "SERIALIZER", "microservices_framework.core.cache.backends.redis.serializers.pickle.PickleSerializer")
        serializer_cls = load_class(serializer_path)

        compressor_path = self._options.get(
            "COMPRESSOR", "microservices_framework.core.cache.backends.redis.compressors.identity.IdentityCompressor")
