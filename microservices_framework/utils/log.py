...
DEFAULT_LOGGING = {
    ...
    'filters': {
        'require_debug_false': {
            '()': 'microservices_framework.utils.log.RequireDebugFalse',
        },
        'require_debug_true': {
            '()': 'microservices_framework.utils.log.RequireDebugTrue',
        },
    },
    'formatters': {
        'app.server': {
            '()': 'microservices_framework.utils.log.ServerFormatter',
    ...
    'handlers': {
        ...
        'mail_admins': {
            ...
            'class': 'microservices_framework.utils.log.AdminEmailHandler'
        }
    },
    'loggers': {
        'app': {
